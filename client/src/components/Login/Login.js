    ...
    return (
        <div className='login'>
            ...
            <div className='login-images'>
                <h1>Picstagram</h1>
                <img src='https://images.unsplash.com/photo-1605663585104-02b44080a242?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60' alt='Not Found' />
            </div>
